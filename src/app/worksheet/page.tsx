...
export default function Page() {
  ...
  return (
    <main className="flex flex-col min-h-screen items-center justify-center p-2 md:p-10">
      ...
      <div className="hidden md:flex md:items-center md:mt-2 md:flex-row md:gap-2">
        <div className="peer block w-[10px] h-[20px] text-sm" >#</div>
        <div className="peer block w-[125px] h-[20px] text-sm" >Input Value</div>
        <div className="peer block w-[125px] h-[20px] text-sm" >Starting Unit</div>
        <div className="peer block w-[125px] h-[20px] text-sm" >Ending Unit</div>
        <div className="peer block w-[125px] h-[20px] text-sm" >Student Answer</div>
